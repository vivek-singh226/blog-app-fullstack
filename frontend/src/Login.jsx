          ...
          <div className="max-w-md w-full mx-auto">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-2xl">
                  <div className="p-8">
                          ...
                          <div className="mb-5">
                              <label htmlForfor="password" className="block mb-2 text-sm font-medium text-gray-600">Password</label>
                  ...
                  <div className="flex justify-between p-8 text-sm border-t border-gray-300 bg-gray-100">
                      <Link to='/' className="font-medium text-indigo-500">Create account</Link>
